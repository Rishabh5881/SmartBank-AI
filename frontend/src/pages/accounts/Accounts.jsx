...
const Accounts = () => {
    ...
    const fetchAccounts = async (isRefresh = false) => {
      try {
        ...
        if (!responseData?.success) {
          setAccounts([]);
          setError(
            responseData?.message || "Unable to load accounts."
          );
          return;
        }
  ...
  const normalizedAccounts = useMemo(() => {
    return accounts.map((account, index) => {
      ...
      return {
        ...
        health:
          Number(account?.health) || null,

        utilization:
          Number(account?.utilization) || null,
  ...
  const currency =
    normalizedAccounts[0]?.currency || "INR";
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <button
              ...
              className="group flex items-center gap-2 rounded-xl border border-cyan-400/20 bg-cyan-400/[0.08] px-4 py-3 text-sm font-semibold text-cyan-300 transition-all duration-300 hover:border-cyan-400/40 hover:bg-cyan-400/[0.14] hover:text-white"
            >
              <Plus
                size={17}
        ...
        {showAddAccountModal && (
          ...
          >
            <motion.div
              ...
              className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-[30px] border border-white/[0.08] bg-[#07101f] p-6 shadow-2xl shadow-black/50 sm:p-8"
            >
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cyan-400/10 text-cyan-400">
              ...
              <p className="mt-5 text-sm leading-6 text-slate-500">
                Create a new bank account and start managing your finances
                securely from SmartBank AI.
              </p>
              ...
              >
                ...
                <div className="mt-5">
                  ...
                  <div className="relative">
                    <div className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 text-sm font-bold text-cyan-400">
                      ₹
                    </div>
                    ...
                    <input
                      ...
                      disabled={creatingAccount}
                      placeholder="0.00"
                      className="w-full rounded-2xl border border-white/[0.08] bg-white/[0.035] py-3.5 pl-9 pr-4 text-sm font-semibold text-white outline-none transition placeholder:text-slate-700 focus:border-cyan-400/40 focus:bg-cyan-400/[0.03] focus:ring-2 focus:ring-cyan-400/10 disabled:cursor-not-allowed disabled:opacity-50"
                    />
                  </div>

                  <p className="mt-2 text-[11px] leading-5 text-slate-600">
                    Enter the amount you want to deposit when creating this
                    account.
                  </p>
                </div>

                <div className="mt-6 flex gap-3 rounded-2xl border border-emerald-400/10 bg-emerald-400/[0.035] p-4">
                  <ShieldCheck
                    size={18}
                    className="mt-0.5 shrink-0 text-emerald-400"
                  />
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[10px] leading-5 text-slate-600">
                      Your account will be associated with your currently
                      authenticated SmartBank AI profile.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-7 grid gap-3 sm:grid-cols-2">
                  ...
                  <button
                    type="submit"
                    disabled={creatingAccount}
                    className="flex items-center justify-center gap-2 rounded-xl bg-cyan-400 px-4 py-3.5 text-xs font-bold text-slate-950 transition hover:bg-cyan-300 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {creatingAccount ? (
                      <>
                        <Loader2
...
const QuickAction = ({
  ...
  return (
    <button
      type="button"
      className="group flex items-center gap-4 rounded-2xl border border-white/[0.07] bg-white/[0.025] p-4 text-left transition-all duration-300 hover:-translate-y-1 hover:border-cyan-400/15 hover:bg-cyan-400/[0.035]"
    >
